...
function draw() {
  ...
  textAlign("center");
  textSize(30);
  text("Remaining Arrows : " + numberOfArrows, 900, 500);
...
function gameover(){
  swal({
title:"Gameover!!!",
text:"Thanks for wasting your time Stupid !!",
imageUrl:
"https://image.shutterstock.com/image-illustration/3d-illustration-archery-target-hit-260nw-84186868.jpg",
imageSize:"150x150",
confirfButtonText:"PLAY AGAIN"
  },
  function (isConfirm){
    if(isConfirm){
      location.reload();
